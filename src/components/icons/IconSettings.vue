...
<template>
  <div class="icon-container" :style="[iconC, hoverShadown]" @mouseover="handleMouseHover" @mouseleave="handleMouseLeave">
    <svg id="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" :style="icon">
      <g id="settings">
        <line class="icon-normalize" x1="58.57" y1="30.53" x2="82.1" y2="30.53" />
        <line class="icon-normalize" x1="17.9" y1="30.53" x2="23.73" y2="30.53" />
        <line class="icon-normalize" x1="17.9" y1="50" x2="82.1" y2="50" />
        <ellipse class="icon-normalize" cx="41.15" cy="30.53" rx="8.13" ry="8.38" />
        <path d="M48.68,35.16a.22.22,0,0,0,0-.44.22.22,0,0,0,0,.44Z" />
        <line class="icon-normalize" x1="41.43" y1="69.47" x2="17.9" y2="69.47" />
        <line class="icon-normalize" x1="82.1" y1="69.47" x2="76.27" y2="69.47" />
        <ellipse class="icon-normalize" cx="58.85" cy="69.47" rx="8.13" ry="8.38" />
