...
<template>
  <div class="icon-container" :style="[iconC, hoverShadown]" @mouseover="handleMouseHover" @mouseleave="handleMouseLeave">
    <svg version="1.1" id="svg1" :style="icon" viewBox="0 0 100 100" xmlns:xlink="http://www.w3.org/1999/xlink"
      ...
      <g id="layer-MC0" transform="translate(-3513.2831)">
        <g id="g21" transform="matrix(0.26126231,0,0,0.26126231,3350.0097,-138.10886)">
          <path class="icon-normalize" d="M 712.06752,720 H 919.69888" id="path13" />
          <path class="icon-normalize" d="M 823.2817,638.90015 925.11495,720 823.2817,801.09985" id="path21" />
        </g>
      </g>
    </svg>
  </div>
