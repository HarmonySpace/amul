...
<template>
  <form class="container form-container">
    ...
    <div class="container box">
      <InputText @iinput="textChange1" :ph="props.ph1" :nm="props.nm1" :lb="props.lb1" :ct="props.ct1" :lg="props.lg1"
        :ty="props.ty1" />
      <InputText @iinput="textChange2" :ph="props.ph2" :nm="props.nm2" :lb="props.lb2" :ct="props.ct2" :lg="props.lg2"
        :ty="props.ty2" />
    </div>
  </form>
</template>
